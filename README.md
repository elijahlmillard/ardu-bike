...
<div style="text-align:center; font-family:Segoe UI, Roboto, sans-serif; line-height:1.6;">
  ...
  <img 
    src="https://github.com/user-attachments/assets/e90f9235-1935-4dad-830e-e705696a935b"
    alt="ArduBike Logo"
    style="width:50%; max-width:256px; height:auto; image-rendering:pixelated; image-rendering:crisp-edges; margin-bottom:1em;"
  />

  <p style="font-size:1.1em; margin:0 0 0.8em;">
    <strong>ArduBike</strong> - a simple, goalless game about riding a bike.<br>
    Developed for the <strong>Arduboy</strong> handheld console.
  </p>
